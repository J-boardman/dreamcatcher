import { g as get_store_value, o as onDestroy, d as setContext } from "../../../../chunks/lifecycle.js";
    ...
    try {
      ...
      while (true) {
        ...
        if (experimental_onFunctionCall) {
          ...
          const functionCallResponse = await experimental_onFunctionCall(get_store_value(messages), functionCall);
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<main class="mt-2 ml-2 flex flex-col flex-1 gap-2"><div class="flex-1 flex flex-col max-h-[calc(100dvh-1rem)] md:max-h-[calc(100dvh-4.5rem)] overflow-scroll gap-2">${slots.default ? slots.default({}) : ``}</div></main>`;
});
export {
  Layout as default
};
